...
public class SimpleGameModelA extends GameModel {
	...
	public Person zhaozilong() {
		if (this.zhaozilong == null) {
			...
			Cell cell = getCellCreator().createCell(
					3 * getGameConfig().getBaseImageLength(), 0, name);
	...
	public Person caocao() {
		if (this.caocao == null) {
			String name = "caocao";
			Cell cell = getCellCreator().createCell(
					1 * getGameConfig().getBaseImageLength(),
					0, name);
	...
	public Person[] samurais() {
		if (this.samurais == null) {
			...
			samurais[0] = new Person(name, getCellCreator().createCell(0, 4 * getGameConfig().getBaseImageLength(),
					name));
			name = "samurai1";
			samurais[1] = new Person(name, getCellCreator().createCell(
					1* getGameConfig().getBaseImageLength(), 3 * getGameConfig().getBaseImageLength(), name));
			name = "samurai2";
			...
			samurais[3] = new Person(name, getCellCreator().createCell(
					3 * getGameConfig().getBaseImageLength(),
					4 * getGameConfig().getBaseImageLength(), name));
